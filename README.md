...
2. Introducción de pruebas automatizadas con pytest. Tendrás que escribir y ejecutar pruebas automatizadas para garantizar que la funcionalidad principal del chatbot funciona como se espera y evitar regresiones a medida que se añaden nuevas características.

3. Establecer un proceso de integración continua. Tendrás que automatizar el proceso de creación y prueba para obtener información temprana sobre los cambios en el código y asegurarte de que el chatbot está siempre en condiciones de ser desplegado.

Recuerda que el objetivo no es sólo escribir código, sino establecer un flujo de trabajo de desarrollo eficiente y colaborativo que adopte los principios de Agile.

El objetivo de este proyecto es guiar al equipo de desarrollo ágil a través del primer sprint de construcción de un chatbot para una librería en línea, centrándose en establecer una base sólida con control de versiones (Git y GitHub), pruebas automatizadas (pytest) y un proceso de integración continua.
